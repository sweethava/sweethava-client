...
import { Float, Sparkles, useGLTF, useScroll } from '@react-three/drei'
...
const PainterStuff = () => {
    ...
    useFrame(() => {
        const scrollTop = window.scrollY / (document.children[0].scrollHeight - window.innerHeight) * 5

        ref.current.rotation.y = scrollTop
    })
